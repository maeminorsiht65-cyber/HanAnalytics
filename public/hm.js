...
;(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "3e8e" + "006e5e5754b9f65a9e303490" + "3cd4",
        dm: ["admin5.com"],
    ...
    (function() {
        ...
        mt.d.Ub = function(b, k) {
            ...
            d = a.f(window.location.protocol, d.substring(6, d.length))) : e.Z(b) || (d = mt.d.Qa(b),
    ...
    mt.localStorage.set = function(e, a, b) {
        ...
        try {
            ...
            mt.localStorage.g.load("admin5.com"),
            mt.localStorage.g.setAttribute(e, a),
            mt.localStorage.g.save("admin5.com"))
        } catch (d) {}
    }
    ;
    mt.localStorage.get = function(e) {
        if (window.localStorage) {
            ...
            try {
                return mt.localStorage.g.load("admin5.com"),
    ...
    (function() {
        var e = mt.lang
          ...
          , b = {
            ...
            la: function(a, d) {
                return b.ma(h.b && h.b.a && h.b.a.u, a, d) || b.ma(window.location.protocol, a, d)
            },
            ma: function(b, d, f) {
                if (b === s)
                    return x;
                ...
                return RegExp("^" + d.replace(/[?.+^${}()|[\]\\]/g, "\\{%value}").replace(/\*/g, ".*") + "$").test(b)
            },
            H: function(a, d) {
                var f = b.Oa(a);
                if (!e.i(f, "Undefined")) {
    ...
    (function() {
        var e = mt.url
          ...
          , d = {
            ...
            I: function() {
                for (var a = "admin5.com", b = 0, d = c.dm.length; b < d; b++)
                    if (e.qb(a, c.dm[b]))
        ...
        var a = mt.url
          ...
          , n = {
            ...
            _trackPageview: function(b) {
                ...
                h.b.a.ep = "",
                h.b.a.vl = d.W(),
                n.Y || (h.b.a.su = h.b.a.u || window.location.protocol),
            ...
            _setReferrerOverride: function(a) {
                1 < a.length && (a = a[1],
                b.i(a, "String") ? (h.b.a.su = "/" === a.charAt(0) ? f.protocol + "//" + "admin5.com" + a : a,
                n.Y = t) : n.Y = x)
            },
    ...
    (function() {
        ...
        e.prototype = {
            ...
            nb: function() {
                var b = a.V(window.location.protocol);
            ...
            Eb: function() {
                ...
                this.a.vl = f.W();
                var b = "https://www.admin5.com/?" + window.location.href;
            ...
            va: function(a) {
                ...
                var e = this.a.u ? "" : "&u=" + encodeURIComponent(window.location.protocol);
